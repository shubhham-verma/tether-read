            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button
                  ...
                  className={`flex-1 py-3 px-6 rounded-lg font-semibold transition-colors duration-200 flex items-center justify-center gap-2 hover:cursor-pointer ${
                    isUploading
                ...
                >
                  {isUploading ? (
                    ...
                    <>
                      <FaCheckCircle className="w-4 h-4 cursor-pointer" />
                      Add to Library
                    </>
                  )}
                </button>
